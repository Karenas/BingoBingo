...
import com.gmself.studio.mg.basemodule.R;

import java.util.ArrayList;
import java.util.List;

public class CV_ActionSheetDialog {
...
//	private TextView txt_cancel;
	...
	public CV_ActionSheetDialog(Context context) {
	...
	public CV_ActionSheetDialog builder() {
		// 获取Dialog布局
...
//		});
	...
	public CV_ActionSheetDialog setTitle(String title) {
		showTitle = true;
	...
	public CV_ActionSheetDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public CV_ActionSheetDialog setCanceledOnTouchOutside(boolean cancel) {
	 ...
	 * @return
	 */
	public CV_ActionSheetDialog addSheetItem(String strItem, SheetItemColor color, OnSheetItemClickListener listener) {
